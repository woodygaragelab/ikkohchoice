    ...
    return (
      <div className="mt-5 container-fluid k2310BgH">
        ...
        <div className="k2Header k2310BgH">
          <div onClick={this.selectBook} className="col-6">Book</div>
          <div onClick={this.selectFood} className="col-6 k2310FgH">Food</div>
        </div>
          ...
          this.state.items.map(item => (
            <div className="card" key={item.id || item.name}>
              <div className="card-body bg-color-2">
                <div className="row">
                  <div className="col-2">
                    {/* <img src={item.imageurl} style={{width: auto,height:100}} alt=""/> */}
